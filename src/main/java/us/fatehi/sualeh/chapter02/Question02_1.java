...
public class Question02_1 {
  ...
  /** If we can use a buffer, we can keep track of elements in a set and remove any dupes */
   ...
   * “runner” iterates through all prior nodes to check for dupes. Runner will only see one dupe per
   * node, because if there were multiple duplicates they would have been removed already.
   */
