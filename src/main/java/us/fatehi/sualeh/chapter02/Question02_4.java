...
/**
 * 2.4 You have two numbers represented by a linked list, where each
...
public class Question02_4
{
   ...
   * carry.
   */
  public static LinkedListNode addLists(final LinkedListNode l1,
                                        final LinkedListNode l2,
                                        final boolean carry)
  {
    if (l1 == null && l2 == null)
    {
    ...
    final LinkedListNode more = addLists(l1 == null? null: l1.next,
