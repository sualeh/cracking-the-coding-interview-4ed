...
public class Question01_1 {
  ...
  /**
   * For simplicity, assume char set is ASCII (if not, we need to increase the storage size. The
   * rest of the logic would be the same). NOTE: This is a great thing to point out to your
   * interviewer! Time complexity is O(n), where n is the length of the string, and space complexity
   * is O(n).
   */
  ...
  /**
   * Code with error-checking that takes care of Unicode characters. Unicode code points are
   * integers.
   */
