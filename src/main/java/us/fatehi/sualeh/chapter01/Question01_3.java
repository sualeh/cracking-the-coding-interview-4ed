...
public class Question01_3 {
   ...
   * additional array of constant size? Algorithm — No (Large) Additional Memory:
   *
   * <ol>
   *   <li>For each character, check if it is a duplicate of already found characters.
   *   <li>Skip duplicate characters and update the non duplicate characters.
   * </ol>
   *
