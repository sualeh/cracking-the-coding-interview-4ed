...
public class Question01_8 {
   ...
   *
   * <ol>
   *   <li>Check if length(s1) == length(s2). If not, return false.
   *   <li>Else, concatenate s1 with itself and see whether s2 is substring of the result.
   * </ol>
   *
   * <p>input: s1 = apple, s2 = pleap ==> apple is a substring of pleappleap
   *
   * <p>input: s1 = apple, s2 = ppale ==> apple is not a substring of ppaleppale
   */
