...
public class Question04_5 {
   ...
   * X.successor(), we do the following:
   * 1. If X has a right child, then the successor must be on the right
   * side of X (because of the order in which we visit nodes).
   * Specifically, the left-most child must be the first node visited
   * in that subtree.
